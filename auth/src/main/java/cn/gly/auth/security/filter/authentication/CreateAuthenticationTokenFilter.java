package cn.gly.auth.security.filter.authentication;

import cn.gly.auth.security.config.SecurityProperties;
import cn.gly.auth.security.model.dto.AuthenticationUser;
import cn.gly.auth.security.model.request.AuthenticationRequest;
import cn.gly.auth.security.model.response.AuthenticationFailResponse;
import cn.gly.auth.security.model.response.AuthenticationResponse;
...
public class CreateAuthenticationTokenFilter extends AbstractAuthenticationProcessingFilter {
     ...
     * 默认就会提交到{@link DaoAuthenticationProvider}
